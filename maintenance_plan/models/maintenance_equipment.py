...
class MaintenanceEquipment(models.Model):
    ...
    maintenance_plan_ids = fields.One2many(string="Maintenance plan", comodel_name="maintenance.plan",
                                           inverse_name="equipment_id", )
    maintenance_plan_count = fields.Integer(compute="_compute_maintenance_plan_count", string="Maintenance Plan Count",
                                            store=True, )
    ...
    @api.depends("maintenance_plan_ids.next_maintenance_date", "maintenance_ids.request_date")
