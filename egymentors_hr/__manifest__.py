...
""",
    ...
    'data': [
        ...
        'reports/reports.xml',
        'reports/report_hr_bonus.xml',
        'reports/report_hr_penalty.xml',
        'reports/report_hr_employee_promotion.xml',
        'reports/report_hr_employee_transfer.xml',
        'reports/report_hr_pay_raise.xml',
        'reports/report_hr_trans_allowance.xml',
        'reports/report_hr_award_profit.xml',
        'reports/report_payslip_salary_rules_pdf.xml',
    ],
    'installable': True,
    'application': True,
    'auto_install': False,
