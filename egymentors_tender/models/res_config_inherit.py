...
class InventoryConfigSetting(models.TransientModel):
    ...
    def get_values(self):
        ...
        res['stock_generate_seq'] = bool(self.env['ir.config_parameter'].get_param('egymentors_tender.stock_generate_seq'))
    ...
    def set_values(self):
        ...
        self.stock_generate_seq and self.env['ir.config_parameter']. \
            set_param('egymentors_tender.stock_generate_seq', self.stock_generate_seq)
