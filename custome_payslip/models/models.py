...
class custome_payslip(models.Model):
    _inherit = 'hr.payslip'
    def action_validate(self):
        super (custome_payslip, self).action_validate ()
    ...
    def action_payslip_done(self):
        ...
        """
        res = super(custome_payslip, self).action_payslip_done()
        ...
        for journal_id in slip_mapped_data: # For each journal_id.
            for slip_date in slip_mapped_data[journal_id]: # For each month.
                ...
                move_dict['ref']=self.payslip_run_id.name
